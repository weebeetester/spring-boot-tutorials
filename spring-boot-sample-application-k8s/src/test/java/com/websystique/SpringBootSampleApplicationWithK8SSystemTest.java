...
@ActiveProfiles("test")
public class SpringBootSampleApplicationWithK8SSystemTest {
    @LocalServerPort
    private int port;
    ...
    public void homePage() throws Exception {
        assertThat(this.restTemplate.getForObject("http://localhost:" + port + "/", String.class)).contains("Welcome to <span>Sample SpringBoot App");
    }
